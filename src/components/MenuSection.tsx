              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                  ...
                  <div className="pt-3 border-t border-borderWarm/70 flex items-center justify-between gap-3">
                    ...
                    <div>
                      {qty > 0 ? (
                        <div className="flex items-center border border-caramel-500/40 rounded-md bg-cream-100 overflow-hidden shadow-2xs">
                          <button
                            type="button"
                          ...
                          <span className="px-2.5 font-bold text-sm text-brown-950 min-w-[24px] text-center">
                            {qty}
                          </span>
                          <button
                            type="button"
